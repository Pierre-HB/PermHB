...
namespace salseman512 {
    ...
    void computePartialSalseman(unsigned long long n, float distanceMatrix[], int nbCity, int NCPUT, threadStream& stream) {
        ...
        __m512 _partialDistance = _mm512_setzero_ps();//puisque certaine ville seront toujours placer au même endroit dans les diferents chemin, ont peut calculer la distance parcourue une seul fois
